...
布咕是基于CIM组件开发的一整套完整的产品,面向所有人开放注册的试用场景。具有丰富的功能，聊天、群组、好友列表、黑名单、公众号、朋友圈等功能。不依赖任何第三方服务，可以私有化部署。
...
<div align="center">
   ...
   <img src="http://staticres.oss-cn-hangzhou.aliyuncs.com/hoxin/p2p_chatting_dark.jpg" width="24%"  />
